<?php namespace App\Http\Controllers;
	...
	class AdminClientesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        $this->col = [];
			$this->col[] = array("label"=>"Rif","name"=>"rif" );
			$this->col[] = array("label"=>"Cliente","name"=>"cliente" );

			# END COLUMNS DO NOT REMOVE THIS LINE
			# START FORM DO NOT REMOVE THIS LINE
		$this->form = [];
		$this->form[] = ["label"=>"Cliente","name"=>"cliente","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
		$this->form[] = ["label"=>"Rif","name"=>"rif","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:25"];
